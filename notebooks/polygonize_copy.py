...
imgs_path = '/Users/MacBookPro/Documents/Berkeley/ExplainableFire/doi_10.6071_M3QX18__v7/burn_severity_CA/'
imgs = glob.glob(os.path.join(imgs_path,'*_burn_severity_CA.tif'))
...
if __name__ == "__main__":
    ...
    for img in imgs:
        ...
        dem = rx.open_rasterio(img)
        fid = img.split('/')[-1].split('_burn_severity_CA.tif')[0].lower()
        ...
        union_vector_gdf.to_file(f"""burn_extent/burn_{fid}.gpkg""", crs='EPSG:4326', driver='GPKG')